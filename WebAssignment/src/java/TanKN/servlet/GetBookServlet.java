...
public class GetBookServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<BookDTO> list=(List<BookDTO>)(session.getAttribute("BOOKLIST"));
            if(list==null){
                list=new ArrayList<>();
            }
            ...
            log("GetBookServlet_SQLException "+ex.getMessage());
        } catch (NamingException ex) {
            log("GetBookServlet_NamingException "+ex.getMessage());
        }
        finally{
